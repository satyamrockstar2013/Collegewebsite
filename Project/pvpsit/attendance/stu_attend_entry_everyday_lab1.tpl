  ...
  <TR>
	...
	<TR>
		...
		<FORM  name="attend" action="index.sit" method="post" >
				<INPUT type="hidden" name="service" value="STU_ATTEND_ENTRY_EVERYDAY_LAB">
		{php}
				...
				if($type == 'p' || $type == 'd')
				{
					echo "<TR>
						<TD align='center' colspan='3' align='right'><font color='red'><b>Total No. of Hours:
							<INPUT type='text' name='classes' value=".$tperiod.">
						</TD>
						</TR><TR><TD>&nbsp;</TD></TR>";
				}
	...
	<TD width="60%">
		...
		<TR><TD>
			...
			<TR>
				<TD>
					<TABLE border="1" width="100%" cellspacing="0" cellpadding="0">
					<TR><TD align=center width=10%><FONT COLOR='LIGHT BLUE'><B>STID</TD>
				...
				{     
					...
					if($type == 'p'  || $type == 'd' )
					{
						...
						echo "<TD width='10%' align=center><INPUT type=checkbox name=".$student->fields[0]."c   class='case' CHECKED></TD>";
